...
public class LabelDisplay {
  ...
  public void onDrawBannerList(List<Banner> banners, ARPose cameraPose, float[] cameraProjection) {
    float[] cameraViewMatrix = new float[MATRIX_SIZE];
    cameraPose.inverse().toMatrix(cameraViewMatrix, 0);
    drawBanners(banners, cameraViewMatrix, cameraProjection);
  }

  private void drawBanners(List<Banner> banners, float[] cameraViewMatrix, float[] cameraProjection) {
